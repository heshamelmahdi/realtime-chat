...
export const proxy = async (req: NextRequest) => {
  ...
  // - If user is not allowed, redirect to lobby.
  // - If user is allowed, continue to room page.

  // localhost:3000/room/1234567890
  ...
  // USER HAS TOKEN BUT NOT ALLOWED TO JOIN ROOM
